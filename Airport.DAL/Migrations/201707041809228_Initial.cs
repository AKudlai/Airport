    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.FlightNumber, t.TicketNumber })
                .ForeignKey("dbo.Flights", t => t.FlightNumber, cascadeDelete: true)
                .ForeignKey("dbo.Tickets", t => t.TicketNumber, cascadeDelete: true)
        ...
        {
            DropForeignKey("dbo.FlightTickets", "TicketNumber", "dbo.Tickets");
            DropForeignKey("dbo.FlightTickets", "FlightNumber", "dbo.Flights");
